<h2 class="text-xl font-bold">داده‌های نمونه</h2>
<p class="mt-3 leading-7 text-slate-600">
    برای آشنایی با سامانه می‌توانید داده‌های نمونه (شعبه، دپارتمان، سمت و چند کاربر آزمایشی) ایجاد کنید.
    این مرحله اختیاری است و در محیط عملیاتی توصیه نمی‌شود.
</p>
